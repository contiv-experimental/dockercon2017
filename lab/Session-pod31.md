...
Run SecureCRT, and click on pod31. 
...
#### Step 4: Install contiv on pod31-srv1 and pod31-srv2
...
Let us run a couple of more containers in the host `pod31-srv1` that belong to the tenant `blue`:
