...
Run SecureCRT, and click on pod11. 
...
#### Step 4: Install contiv on pod11-srv1 and pod11-srv2
...
Let us run a couple of more containers in the host `pod11-srv1` that belong to the tenant `blue`:
